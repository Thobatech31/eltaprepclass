...
<div class="main-container">
			...
			<div class="row">
				<div class="col-sm-7">
					<div class="switchable__text">
						<h3 id="header2">TAKE CHARGE OF YOU LIFE.</h3>
						<p class="lead" id="ieltsText">
				...
				<div class="col-sm-5 col-md-4 col-xs-12 text-center">
	...
	<section class="text-center bg--secondary">
		<div class="container">
			<h3 id="header2">BENEFITS OF WRITING IELTS</h3><br>
			<div class="row">

				<div class="col-sm-4">
					<div class="feature feature-4 boxed boxed--lg boxed--border" style="padding-bottom: 70px;">
						<i class="color--primary icon icon--lg icon-Life-Safer"></i>
						<h4 id="header2">For Study</h4>
						<hr>
						<p align="center" id="ieltsText">
				...
				<div class="col-sm-4">
					<div class="feature feature-4 boxed boxed--lg boxed--border" style="padding-bottom: 70px;">
						<i class="color--primary icon icon--lg icon-Life-Safer"></i>
						<h4 id="header2">For Immigration</h4>
						<hr>
						<p align="center" id="ieltsText">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
					<h3 id="ieltsheader">Let us help you get there</h3>
					<p class="lead" id="ieltsText">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4 col-md-3">
					<h3 id="header2">Experience quality</h3>
					<p class="lead" id="ieltsText">
						Getting a scholarship to study in Top universities abroad is easier than you think
					</p>
				</div>
						...
						<ul class="slides flickity-enabled is-draggable" tabindex="0">
							...
							<div class="flickity-viewport" ><div class="flickity-slider" style="left: 0px; transform: translateX(-300%);"><li class="slide is-selected" style="position: absolute; left: 300%;">
										<div class="">
											...
											<h3 id="ieltsheader">Harvard business school</h3>
											<span class="h3" id="ieltsText">
									...
									<li class="slide" style="position: absolute; left: 200%;">
										<div class="">
											<!--<img alt="Image" src="img/avatar-round-4.png" class="image--sm">-->
											<h3 id="ieltsheader">Said business school UK</h3>
											<span class="h3" id="ieltsText">
									...
									<li class="slide" style="position: absolute; left: 100%;">
										<div class="">
											<!--<img alt="Image" src="img/avatar-round-4.png" class="image--sm">-->
											<h3 id="ieltsheader">ESMT MBA scholarships</h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 col-sm-6">
					<h3 id="header">Let Us Help You Reach That Target Score With Our Experienced Tutors</h3>
					<p class="lead" id="ieltsText">
