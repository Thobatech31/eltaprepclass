...
<div class="main-container">
	<section class="cover cover-features imagebg space--lg" height="70%"  data-scrim-bottom="9">
		<div class="background-image-holder">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 col-md-7">
					<h2>End-to-end planning and construction</h2>
					<p class="lead">
				...
				<div class="col-sm-4 col-md-3">
					<div class="text-block">
						<h5>Global</h5>
						<p>
							enquiries@stackconstruction.net
						</p>
					</div>
					<div class="text-block">
						<h5>Melbourne</h5>
	...
	<section class="imageblock switchable feature-large bg--dark">
		<div class="imageblock__content col-md-6 col-sm-4 pos-right">
			<div class="background-image-holder">
				<img alt="image" src="img/construction-2.jpg" />
			</div>
		</div>
		<div class="container">
			<div class="row">
				<div class="col-md-5 col-sm-7">
					<h2>Class-leading design and building processes</h2>
					<p class="lead">
	...
	<section class="unpad hidden">
		<div class="masonry masonry--gapless">
			<div class="masonry__container bg--secondary">
				<div class="col-sm-6 col-xs-12 masonry__item" data-masonry-filter="Marketing">
				...
				<div class="col-sm-6 col-xs-12 masonry__item" data-masonry-filter="Design">
					<div class="project-thumb hover-element height-40">
						<a href="#">
							<div class="hover-element__initial">
								<div class="background-image-holder">
