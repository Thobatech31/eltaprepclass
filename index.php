...
<main class="homepage">
	...
	<div class="widget2-bg" style="background-image: url('assets/img/circle.png');">
		<div class="container">
			<div class="extend-wrap widget widget2">
			...
			<div class="row">
				<div class="col-md-3 col-sm-6">
					<div class="card" style="background-color: #0276FD">
						...
						<h6 style="color: white; font-weight: bold">United State</h6>
				...
				<div class="col-md-3 col-sm-6">
					<div class="card" style="background-color: #0276FD">
						...
						<h6 style="color: white; font-weight: bold">Canada</h6>
				...
				<div class="col-md-3 col-sm-6">
					<div class="card" style="background-color: #0276FD">
						...
						<h6 style="color: white; font-weight: bold">China</h6>
				...
				<div class="col-md-3 col-sm-6">
					<div class="card" style="background-color:#0276FD">
						<img alt="background" src="assets/img/education-3.jpg">
						<h6 style="color: white; font-weight: bold">Nigeria</h6>
